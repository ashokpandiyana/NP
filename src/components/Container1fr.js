...
import "./Container1fr.css";
import Skills from "./Skills";

const Container1fr = () => {
  return (
    <>
      <div className="contact-me">Contact Details</div>
      <div className="contact-container">
        <a
          href="mailto:ashokpandiyan431998@gmail.com"
        ...
        <a
          href="https://github.com/ashokpandiyana"
          rel="noopener noreferrer"
          target="_blank"
          className="icon"
        >
        ...
        <a
          href="https://www.linkedin.com/in/ashokpandiyana/"
          rel="noopener noreferrer"
          className="icon"
          target="_blank"
        >
        ...
        <a
          href="https://leetcode.com/ashok_a43/"
          rel="noopener noreferrer"
          className="icon"
          target="_blank"
        >
        ...
        <a
          href="https://ashokpandiyanaprofile.web.app/"
          rel="noopener noreferrer"
          className="icon"
          target="_blank"
        >
